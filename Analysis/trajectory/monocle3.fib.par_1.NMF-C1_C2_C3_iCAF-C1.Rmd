---
title: "monocle3.fib.par_1.NMF-C1_C2_C3_iCAF-C1"
---

Run on T01

```{r knitr, include = FALSE}
DOCNAME = "monocle3.fib.par_1.NMF-C1_C2_C3_iCAF-C1"
...
Subset NMF-C1 -> NMF-C2 -> NMF-C3 -> iCAF-C1
...
cds_sub = cds[,colData(cds) %>%
  as.data.frame() %>%
  filter(level_3 %in% c("NMF-C1", "NMF-C2", "NMF-C3", "iCAF-C1")) %>% #head()
  row.names]
...
ciliated_cds_pr_test_res %>%
  ...
  write_tsv(here::here("output", DOCNAME, 'monocle3.fib.par_1.NMF-C1_C2_C3_iCAF-C1.graph_test.tsv'))
```
