---
title: "monocle3.fib.par_2.pericyte-C1_C3_myCAF-C2"
---

Run on T01

```{r knitr, include = FALSE}
DOCNAME = "monocle3.fib.par_2.pericyte-C1_C3_myCAF-C2"
...
Subset pericyte-C1, pericyte-C3, myCAF-C2

```{r eval=FALSE}
cds = readRDS(here::here('output/04.rm_cells/monocle3_fibroblasts.par_2.rds'))
cds

cds_sub = cds[,colData(cds) %>%
  as.data.frame() %>%
  filter(level_3 %in% c("pericyte-C1", "pericyte-C3", "myCAF-C2")) %>% #head()
  row.names]
...
ciliated_cds_pr_test_res %>%
  ...
  write_tsv(here::here("output", DOCNAME, 'monocle3.fib.par_2.pericyte-C1_C3_myCAF-C2.graph_test.tsv'))
```
