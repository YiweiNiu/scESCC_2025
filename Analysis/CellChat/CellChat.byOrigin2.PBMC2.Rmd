---
title: "CellChat.byOrigin2.PBMC2"
---
...
cellchat = readRDS(here::here("output", DOCNAME, 'cellchat.PBMC2.rds'))
cellchat
```
...
Both Cophenetic and Silhouette values begin to drop suddenly when the number of incoming patterns is 5.
...
```{r save, eval=FALSE}
saveRDS(cellchat, file = here::here("output", DOCNAME, 'cellchat.PBMC2.rds'))
```
