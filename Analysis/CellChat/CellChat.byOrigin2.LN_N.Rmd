...
cellchat = readRDS(here::here("output", DOCNAME, 'cellchat.LN_N.rds'))
cellchat
```
...
```{r vis-each-signaling-pathway, fig.width=5, fig.height=5, results='hide'}
...
```{r save, eval=FALSE}
saveRDS(cellchat, file = here::here("output", DOCNAME, 'cellchat.LN_N.rds'))
```
