---
title: "03.sub_cluster.myeloid.res4"
---
...
DOCNAME = "03.sub_cluster.myeloid.res4"
...
seurat = readRDS(here::here('output/02.cell_type/seurat_myeloid.res4.rds'))
seurat
```
...
```{r classify-myeloid, fig.width=12, fig.height=24}
FeaturePlot(seurat, features = unique(c(markers.myeloid)), ncol = 3)
```
...
known_genes <- c(
    # Macrophage
    "LYZ", "MARCO", "FCER1G", "TYROBP", "CD14", "AIF1",
    # DC
    "IL3RA", "CLEC4C", "HLA-DQA2", "IRF4",
    # mast
