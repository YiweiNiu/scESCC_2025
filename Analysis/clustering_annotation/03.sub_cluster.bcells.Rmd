...
```{r classify-b, fig.width=12, fig.height=24}
FeaturePlot(seurat, features = unique(c(markers.bcells)), ncol = 3)
```
...
known_genes <- c(
    ...
    "IGHM", "IGHD",
    # plasma
    "IGHG1", "IGHG2", "IGHG3", "IGHG4",  "IGHA1", "IGHA2", "FLT3",
    # Breg
    "IL10",
    # MALT
    "JCHAIN",
