---
title: "CellChat.byOrigin2.Adjacent"
---
...
cellchat = readRDS(here::here("output", DOCNAME, 'cellchat.Adjacent.rds'))
cellchat
```
...
data.input <- GetAssayData(srat_sub, assay = "RNA", slot = "data") # Adjacentized data matrix
...
```{r save, eval=FALSE}
saveRDS(cellchat, file = here::here("output", DOCNAME, 'cellchat.Adjacent.rds'))
```
