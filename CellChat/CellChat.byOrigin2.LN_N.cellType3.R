...
# nohup Rscript analysis/CellChat.byOrigin2.LN_N.cellType3.R > analysis/CellChat.byOrigin2.LN_N.cellType3.log &

DOCNAME = "CellChat.byOrigin2.LN_N.cellType3"
...
srat_sub = subset(seurat, Origin2_n == "LN_N")
rm(seurat)
