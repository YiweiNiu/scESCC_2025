---
title: "CellChat.byOrigin2.PBMC1"
---
...
cellchat = readRDS(here::here("output", DOCNAME, 'cellchat.PBMC1.rds'))
cellchat
```
...
```{r save, eval=FALSE}
saveRDS(cellchat, file = here::here("output", DOCNAME, 'cellchat.PBMC1.rds'))
```
