---
title: "CellChat.byOrigin2.Normal"
---
...
cellchat = readRDS(here::here("output", DOCNAME, 'cellchat.Normal.rds'))
cellchat
```
...
Both Cophenetic and Silhouette values begin to drop suddenly when the number of incoming patterns is 6.
...
```{r save, eval=FALSE}
saveRDS(cellchat, file = here::here("output", DOCNAME, 'cellchat.Normal.rds'))
```
